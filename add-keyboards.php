...
if (isset($_POST['submit']))
{
  ...
  $query = "INSERT INTO tblKeyboards (assetCondition, assetAvailability, assetCompany) VALUES ('$assetCondition', '$assetAvailability', '$assetCompany')";

  $result = $db->query($query);
    if ($result)
      echo "Asset added to database";
      echo "<button class='button' href='table-menu.php'>Return to table selection</button>";
      echo "<button class='button' href='tblKeyboards.php'>Return to tblKeyboards</button>";
      $db->close();
}
?>
